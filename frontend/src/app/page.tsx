...
export default function LandingPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1000px", margin: "0 auto", padding: "0 20px 80px" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <motion.div
                ...
                style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#00c9a7" }}
              />
              <span style={{
                fontFamily: "'JetBrains Mono'",
                fontSize: "10px", color: "#00c9a7", letterSpacing: "1.5px",
              }}>LIVE · FREE · OPEN SOURCE</span>
            </div>
        ...
        {/* ══════════════════════════════════════
            CARD ROW 2 — STATS (4 small cards)
        ══════════════════════════════════════ */}
        <div style={{
          display: "grid",
        ...
        <RevealCard delay={0.05} style={{ marginBottom: "16px" }}>
          <div style={{
            ...
            <div style={{
              ...
              {[
                { step: "01", icon: "🎙️", title: "Describe",  desc: "Type or speak your symptoms in any Indian language" },
                { step: "02", icon: "🧠", title: "Analyse",   desc: "AI extracts symptoms and assesses severity instantly" },
                { step: "03", icon: "📋", title: "Triage",    desc: "Get clear guidance — rest, PHC, or hospital ER" },
                { step: "04", icon: "🗺️", title: "Navigate",  desc: "Find nearest facility and get directions in one tap" },
              ].map((s, i) => (
                <div key={i} style={{
                  padding: "24px",
                  borderRight: i < 3 ? "1px solid #0e2530" : "none",
                  borderBottom: "none",
                }}>
                  <div style={{
                    fontFamily: "'JetBrains Mono'",
        ...
        <div style={{
          ...
          <FeatureCard icon="🤖" title="Llama-3 AI Triage"     desc="Real LLM responses — not rule-based. Understands context and asks follow-up questions."  delay={0.05} accent />
          <FeatureCard icon="🎙️" title="Voice in 9 Languages"  desc="Web Speech API with Assamese, Hindi, Bengali, Tamil, Telugu and more."                   delay={0.10} />
          <FeatureCard icon="🧠" title="Medical NER"           desc="Extracts symptoms, duration, severity words and body parts from free-form text."          delay={0.15} />
          <FeatureCard icon="🗺️" title="Live Facility Finder"  desc="OpenStreetMap powered. Shows real hospitals and PHCs near your GPS location."            delay={0.05} />
          <FeatureCard icon="💊" title="Jan Aushadhi Generics" desc="Generic medicine alternatives from PMBI database with savings up to 93%."                 delay={0.10} accent />
          <FeatureCard icon="📄" title="PDF Health Report"     desc="Downloadable summary with symptoms, severity, medicines table and disclaimer."            delay={0.15} />
        </div>

        {/* ══════════════════════════════════════
            CARD 5 — LANGUAGES (wide)
        ══════════════════════════════════════ */}
        <RevealCard delay={0.05} style={{ marginBottom: "16px" }}>
          <div style={{
            background: "#0c1a1f",
